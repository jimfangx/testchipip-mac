...
/* ------------------------------------------------------------------ */
/* Darwin / *BSD don’t define the high-speed termios constants that   */
/* glibc does.  On those systems cfsetispeed/cfsetospeed accept *any* */
/* positive integer, so we can safely map the symbolic names to their */
/* numeric baud‐rate values.                                          */
/* ------------------------------------------------------------------ */
